    ...
    return(
        <div ref={ref}>
           ...
           <div className="text-xl text-black font-bold my-3 mb-1">💡 Why Work With Me? <span className="text-[#6c06f2]">My 3 Cs</span></div>
            ...
            <a href={CV} download="Resume.pdf" className="bg-black flex gap-2 hover hover:bg-[rgb(50,50,50)] items-center py-2 text-[16px] px-5 font-bold mt-7 w-fit rounded-lg text-white tracking-wider" >CV<img className="w-4" src={downloadIcon} alt="" /></a>
        </div>
    )
})
