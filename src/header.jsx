...
export default function Header ({navs}){
    ...
    return(
        ...
        <div className="header flex max-md:flex-col lg:items-center  font-bold justify-between">
            ...
            <div className={` nav max-md:duration-300 max-md:fixed max-md:transition-all max-md:pt-10  max-md:py-6 max-md:pb-24  max-md:bg-white z-30 max-md:w-[100%] ${isToggle ? "max-md:translate-y-[-6rem]" : "max-md:mt-0 max-md:translate-y-[-24rem]"} max-md:ease-in    max-md:flex-col flex gap-[2rem]`}>
