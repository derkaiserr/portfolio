...
import engageX from "./assets/engagex.png";
  ...
  const data = [
    {
      img: engageX,
      title: "Engage X",
      desc: "AI-powered public speaking coach that provides practice sessions, personalized feedback, and performance insights to help users become more confident communicators.",
      link: "https://engagexai.io/",
