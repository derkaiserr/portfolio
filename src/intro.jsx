...
const Intro = React.forwardRef(({scrollToTarget}, ref) =>{
    return(
        <div ref={ref} className="flex break-words tracking-[-0.1rem] gap-9 max-md:flex-col  text-wrap max-md:pt-[0rem]  mt-[10rem]">
            <div className="py-8 max-md:py-0   text-gray-600  leading-[2.5rem] text-2xl  max-md:text-lg">
              ...
              <p className="tracking-tight lg:w-10%">I'm a frontend developer based in Nigeria, I'll help you build beautiful websites your users will love.</p>
